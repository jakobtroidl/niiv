...
p.add_argument('--lr', type=float, default=0.00005, help='learning rate. default=1e-2')
p.add_argument('--num_epochs', type=int, default=1500, help='Number of epochs to train for.')
...
p.add_argument('--batch_size', type=int, default=70, help="Batch size")
opt = p.parse_args()
